...
ContinousModelConstStep::ContinousModelConstStep(Config& config, Beagle::GP::Individual& individual, const Data& data, GP::Context& context)
...
ContinousModelConstStep::~ContinousModelConstStep(void)
{
}

void ContinousModelConstStep::operator() (const StateType &x, StateType &dxdt, const double t)
{
